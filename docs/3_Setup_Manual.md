...
* **Service Portal:** `https://dev294050.service-now.com/sp`
* **Admin Username:** `admin`
* **Password:** `zJrilBJ0@C8*`
...
2. Type `u_database_table.list` and press **Enter**.
...
1. Open a new browser tab and navigate to:
   ```
   https://dev294050.service-now.com/sp
   ```
...
4. Fill in:
   - **Requested For:** `Hari Prakash`
   - **Mobile Number:** `+91 8885286963`
...
1. Once submitted, navigate back to `u_database_table.list`.
